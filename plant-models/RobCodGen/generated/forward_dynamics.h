#ifndef IIT_ROBOT_KUKA_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_KUKA_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot Kuka.
 *
...
inline void ForwardDynamics<TRAIT>::setJointStatus(const JointState& q) const {
    ...
    (motionTransforms-> fr_link7_X_fr_link6)(q);
}
