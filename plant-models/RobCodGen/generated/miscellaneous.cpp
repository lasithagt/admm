...
using namespace iit::Kuka;
using namespace iit::Kuka::dyn;

iit::rbd::Vector3d iit::Kuka::getWholeBodyCOM(
    ...
    const HomogeneousTransforms& ht)
{
    ...
    tmpX = tmpX * ht.fr_link6_X_fr_link7;
    tmpSum += inertiaProps.getMass_link7() *
            ( iit::rbd::Utils::transform(tmpX, inertiaProps.getCOM_link7()));
