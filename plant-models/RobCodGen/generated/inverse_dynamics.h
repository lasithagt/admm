#ifndef IIT_KUKA_INVERSE_DYNAMICS_H_
#define IIT_KUKA_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot Kuka.
 *
...
public:
    ...
    typedef iit::Kuka::tpl::JointState<Scalar> JointState;
    typedef LinkDataMap<Force> ExtForces;
    typedef iit::Kuka::tpl::MotionTransforms<TRAIT> MTransforms;
...
public:
     ...
     *     the robot Kuka, which will be used by this instance
...
public:
    ...
    const Velocity& getVelocity_link7() const { return link7_v; }
    const Acceleration& getAcceleration_link7() const { return link7_a; }
    const Force& getForce_link7() const { return link7_f; }
    ///@}
protected:
...
private:
    ...
    Force         link6_f;
    // Link 'link7' :
    const InertiaMatrix& link7_I;
    Velocity      link7_v;
    Acceleration  link7_a;
    Force         link7_f;
