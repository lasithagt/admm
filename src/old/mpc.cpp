 ...
 */
ModelPredictiveController::ModelPredictiveController(Scalar dt, int time_steps, int HMPC, int iterations, bool verbose, Logger *logger,
		 Dynamics                       &dynamics,
...
void ModelPredictiveController::run(const Eigen::Ref<const State>  &initial_state,
